...
This file is adapted from the official implementation with minimal modifications.
"""
...
class RetinexFormer(nn.Module):
    ...
    Args:
        ...
        n_feat: Number of features (default: 31)
        stage: Number of stages (default: 3)
        num_blocks: Number of blocks in each level (default: [1,1,1])
    """
